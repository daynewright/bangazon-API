...
namespace WebAPIApplication.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public IActionResult Put(int id, [FromBody]Customer customer)
        {
            ...
            try
            {
                Customer currentCustomer = context.Customer.Single(m => m.CustomerId == id);
                ...
                return Ok(new {successful = $"Customer with id {id} updated"});
            }
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                ...
                return Ok(new {successful = $"Customer with id {id} deleted"});
            }
